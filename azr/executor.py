...
ADR-020 Phase 3 deliverable. This module is the VERIFY half of the
...
class SandboxExecutor:
    ...
    def _build_clean_env(self) -> dict[str, str]:
        ...
        (so the solution can't read <canonical-credential-store>/credentials, etc.) and
        every AWARE_* / MINIMAX_* / MODAL_* variable.
        """
