...
//
// --- Passthrough wrap (ADR-022 §Plugin-Local Config + proxy contract) ---
//
...
// three failure modes that ADR-022 closes:
//
...
// cap ADR-022 specifies; the coordinator's own per-request caps
...
function proxyRequest(req, res, done) {
  ...
  // This is the passthrough wrap ADR-022 specifies: the upstream sees
