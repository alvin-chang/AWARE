/**
 * ADR-014: Phase 3.1B — Behavioural Anomaly Detection & Trust Score
 * 
 * Computes trust_score values for ADR-010's security-weighted heuristic function.
...
/**
 * Apply anomaly penalty to pheromone matrix (ADR-011 negative reinforcement).
 * 
