...
class BlastRadiusEstimator {
  ...
  async _estimateGlobal() {
    ...
    return {
      ...
      affectedServices: await this._identifyCriticalServices(allAgents),
    };
  }
   ...
   */
  async _identifyCriticalServices(agents) {
    // This would integrate with service discovery
    // For now, return placeholder
    const criticalRoles = ['orchestrator', 'reviewer', 'tester'];
    const critical = [];
