...
// ============================================================================
// Canonical Serialization (ADR-018 F-2 fix)
// ============================================================================

/**
 * Canonical JSON serialization for deterministic hashing.
 * 
 * Per ADR-018 F-2 fix: canonical JSON format with sorted keys.
 * 
 * @param {DecisionRecord} record
 * @returns {string}
 */
function canonicalSerialize(record) {
  // Field order per ADR-018 spec (sorted alphabetically)
  const fieldOrder = [
    'action',
    'actor',
    'context',
