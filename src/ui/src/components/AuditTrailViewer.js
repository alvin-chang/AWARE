...
import { Box, Typography, Card, CardContent, TextField, Button, Timeline, TimelineItem, TimelineSeparator, TimelineConnector, TimelineContent, TimelineDot, Chip, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Pagination } from '@mui/material';
          ...
          <Card key={decision.id} variant="outlined">
            <CardContent sx={{ py: 1.5 }}>
              <Box display="flex" alignItems="flex-start" gap={2}>
                <TimelineDot color={getDecisionColor(decision.type)} variant="outlined">
