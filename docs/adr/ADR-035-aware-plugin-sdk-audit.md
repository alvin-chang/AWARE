...
**What the actual OC plugin SDK exposes** (verified by reading `/Users/alfie/src/<runtime>/src/plugins/types.ts:1996-2086`):
...
`/Users/alfie/src/<runtime>/src/plugins/types.ts:2067-2074` documents the canonical inference-strategy pattern:
...
**HeavySkill is the canonical example** (see `/Users/alfie/src/heavyskill-plugin/src/strategy.ts` and `/Users/alfie/src/heavyskill-plugin/dist/index.js`).
...
**What the actual contract is** (HeavySkill v4 pattern, `/Users/alfie/src/<runtime>-worktree/extensions/heavyskill/index.js:898-925`):
