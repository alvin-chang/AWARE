...
## From Distributed Systems Platform to Autonomous Compliance Infrastructure
...
> AWARE v1.0.0 — Security Control Plane UI shipped to GitHub (GoodCISO/aware). 214 clean files, Apache 2.0 license, single clean commit history. Gitea remains the dev working copy.
...
1. All pushes go to private repo (Gitea). Never push internal artifacts to GitHub directly.
