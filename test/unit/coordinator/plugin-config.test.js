...
//
// Unit tests for the pluginConfig K resolver (ADR-022 plugin-local
...
//
// Per ADR-022, the wire format is:
//   {
...
//   4. defaultKForTaskType(taskType)  — heavy-think's per-task-type table
//
...
test('resolveK: per-task-type fallback uses heavy-think K_CONFIGS', () => {
  // Sanity check: the table is what we expect. If heavy-think's
