...
//
// Phase 4 (ADR-020 618-627, ADR-029 Repair 4): DPO dataset assembly
...
test('dpo-dataset: minScoreGap also drops inverted pairs (gap < 0)', () => {
  // Documents the gap=−0.05 inversion pattern from ADR-028 Finding 1.
...
test('dpo-dataset: works as second-layer filter after outcome-filter (integration smoke)', () => {
  ...
  //
  // Pair 0: ADR-028 production sample (gap=-0.05, inverted)
  // Pair 1: ADR-028 production sample (gap=-0.40, inverted)
